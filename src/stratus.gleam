...
fn from_socket_message(msg: SocketMessage) -> InternalMessage(user_message) {
  case msg {
    ...
    socket.Err(socket.Closed) -> Closed(SocketFailed)
...
pub fn close_custom(
  ...
  close_with_reason(conn, SendCustomCloseReason(code:, body:))
